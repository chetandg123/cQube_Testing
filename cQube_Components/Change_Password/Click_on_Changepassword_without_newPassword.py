...
class Click_on_pwd(unittest.TestCase):
    ...
    def test_changepassword(self):
        ...
        info = self.driver.find_element_by_xpath("/html/body/app-root/app-home/mat-sidenav-container/mat-sidenav-content/div/app-change-password/div/div/div[2]/form/div[2]/div/label").text
