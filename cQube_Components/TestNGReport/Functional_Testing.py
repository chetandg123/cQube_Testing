...
from cQube_Components.Change_Password import Change_password_Page, Click_on_Changepassword_without_newPassword, \
    Click_on_changepwd, Negative_changepwd, set_new_password, Set_up_new_password
from cQube_Components.Login import Invalid_credentials_check, Login_and_logout, Login_Negative_test, \
    login_test_with_invalid_user, login_to_cQube, login_with_invalid_credentials, login_with_invalid_password, \
    login_with_invalid_user, login_with_unuser, login_with_wrong_user, login_with_wrong_user_password, \
    login_wrong_credentials


from cQube_Components.SR.Clusterwise_validation import Block_cluster, click_on_Cluster_validation, \
...
from cQube_Components.SR import District_dataTest,District_dots,DistrictNames,Dots_check, \
...
class MyTestSuite(unittest.TestCase):
    ...
    def test_Issue(self):
        ...
        Functional_test.addTests([
            ...
            unittest.defaultTestLoader.loadTestsFromTestCase(Click_on_Changepassword_without_newPassword.Click_on_pwd),
            unittest.defaultTestLoader.loadTestsFromTestCase(Click_on_changepwd.Click_ChangePwd),
